function legendaryFarming(str) {
    ...
    for (let [material, qty] of Object.entries(keyMaterials).sort((a, b) => b[1] - a[1] || a[0].localeCompare(b[0]))) {
        console.log(`${material}: ${qty}`);
    }

    for (let [material, qty] of Object.entries(junkMaterials).sort((a, b) => a[0].localeCompare(b[0]))) {
        console.log(`${material}: ${qty}`);
    }
